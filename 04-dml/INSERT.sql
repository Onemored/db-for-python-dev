...
('Janis Joplin'),
('Светлана Лобода');
INSERT INTO artist_genres(genre_id, artist_id) VALUES
(1, 1),
(1, 2),
(2, 3),
(2, 4),
...
(9,10),
(9, 11);
INSERT INTO tracks(track_id, name, album_id, duration) VALUES
...
INSERT INTO compilations (compilation_id, name, release_year) VALUES
(1, 'Rok_only', 2018),
(2, 'Rap_only', 2019),
(3, 'Pop_only', 2020),
(4, 'Jazz_only', 1960),
